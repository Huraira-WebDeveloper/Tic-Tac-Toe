...
{
    /*
        1- | Double every digit from right to left . if double num are 2 digit split them
        2- | Add all single digit from 1.
        3- | Add all odd digit num from right to left.
        4- | Sum result form step 2 and 3.
        5- | If step 4 is divisible by 10 its vaid.
